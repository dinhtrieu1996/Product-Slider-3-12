(function () {
  ...
  var moneyFormat = moneyFormats.hasOwnProperty(moneyCurrency)
    ? moneyFormats[moneyCurrency].money_format
    : "${{amount}}";
  ...
  var get_slider = function (config, id, list_products) {
    ...
    var product_image = config.product_image,
      ...
      image_size_w =
        config.custom_image_size.width != "" ? config.custom_image_size.width : "250",
      image_size_h =
        config.custom_image_size.height != "" ? config.custom_image_size.height : "350",
    ...
    var css = "";
    // Slick Style
css += `.simesy-section-title.preloader{display:none !important;}`;
